...
namespace jd {
    ...
    , m_heartBeat(0) {
        ...
        void GlooxWrapper::setLoginInfo(const char* jid, const char* pwd, const char* host, int port) {
        ...
        void GlooxWrapper::setPresence(int presenceType, int priority, const char* status) {
        ...
        void GlooxWrapper::subscribe(const char* jid, const char* name, const char* groups, const char* msg) {
        ...
        void GlooxWrapper::handleRosterPresence( const RosterItem& item, const std::string& resource,
        ...
        void GlooxWrapper::handleSelfPresence( const RosterItem& item, const std::string& resource,
                                           Presence::PresenceType presence, const std::string& msg )
        {
        ...
        bool GlooxWrapper::handleSubscriptionRequest( const JID& jid, const std::string& msg )
        {
            LOGD( "subscription: %s\n", jid.bare().c_str() );
        ...
        bool GlooxWrapper::handleUnsubscriptionRequest( const JID& jid, const std::string& msg )
        {
        ...
        void GlooxWrapper::handleVCardResult(VCardContext context, const JID& jid, StanzaError se) {
        ...
        void GlooxWrapper::callbackConnect(){
            ...
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackConnect", "()V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackDisconnect(int e){
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackDisconnect", "(I)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackRoster(const Roster& roster) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackRoster", "(Lcom/smilegate/talk/message/RosterArray;)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackVCard(const char* jid, const char* nickname, const char* photo) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackVCard", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackItemSubscribed(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackRosterItemSubscribed", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackItemAdded(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackRosterItemAdded", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackItemUnsubscribed(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackRosterItemUnsubscribed", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackItemRemoved(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackRosterItemRemoved", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackItemUpdated(const char* jid) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackRosterItemUpdated", "(Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackSubscriptionRequest(const char* jid, const char* msg) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackSubscriptionRequest", "(Ljava/lang/String;Ljava/lang/String;)V"))
            {
                return;
            }
...
#ifdef __ANDROID_NDK__
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackUnsubscriptionRequest", "(Ljava/lang/String;Ljava/lang/String;)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackPresence(const RosterItem& roster, const char* resource, Presence::PresenceType presence, const char* msg) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackPresence", "(Lcom/smilegate/talk/message/Roster;Ljava/lang/String;ILjava/lang/String;)V"))
            {
                return;
            }
        ...
        void GlooxWrapper::callbackMessage(const Message& msg, MessageSession* session) {
            ...
            JniMethodInfo methodInfo;
            if (! getStaticMethodInfo(m_jvm, methodInfo, "com/smilegate/talk/message/GlooxWrapper", "callbackMessage", "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"))
            {
                return;
            }
